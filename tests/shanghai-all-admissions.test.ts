...
test("stores official 2021-2025 Shanghai full professional-group lines", () => {
  assert.equal(allAdmissionsDataset.meta.region, "上海");
  assert.deepEqual(allAdmissionsDataset.meta.years, [2021, 2022, 2023, 2024, 2025]);
  assert.equal(allAdmissionsDataset.meta.sourceTrust, "official");
  assert.ok(allAdmissionsDataset.records.length > 6000);
