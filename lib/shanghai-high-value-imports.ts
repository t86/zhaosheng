...
const manifest: ShanghaiHighValueImportManifestEntry[] = [
  {
    ...
    title: "专业层录取结果",
    description:
      "承接《2025 年上海市普通高等学校招生各专业录取人数及考分》里的批次、院校专业组、录取人数、最低分标签、最低分位次、平均分和平均分位次。",
    ...
    optionalFields: ["subjectRequirement", "highestScoreLabel", "minScore", "minRank", "sourceQuality"],
  },
  {
    id: "major-plans",
    title: "在沪计划数",
