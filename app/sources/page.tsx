    ...
    <main className={styles.page}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.sourceGrid}>
          ...
          <div className={styles.sourceCard}>
            ...
            <p>
              整理自上海综评批的流程、计划数、2026 校测入围资格线与专业组等公开信息，第三方补充数据已在板块内标注，
              涉及“适合谁、优缺点、策略建议”的部分按经验判断单独标注，不冒充学校官方统一招生承诺。
            </p>
      ...
      <section className={styles.section}>
        ...
        <ol className={styles.list}>
          ...
          <li>综合评价数据：2026 上海综评校测入围资格线整理截至 2026-07-20（以强基·综评页标注为准）。</li>
