...
export const metadata: Metadata = {
  ...
  description:
    "面向上海高三家长与学生：先分清普通批、综合评价、强基三条路，再用 2021-2026 官方院校专业组线、学校库和高三下时间线判断怎么报 985。数据来源于上海市教育考试院公开口径。",
};
...
const routeCards = [
  {
    ...
    bullets: [
      "按 2021-2026 官方组线做冲、稳、保，而不是只看学校平均分。",
  ...
  },
  {
    ...
    title: "单校攻坚，入围先看分",
    description:
      "目标顶尖 985 的上海高分家庭，强基更适合单校攻坚：先看自己分数够不够入围一所目标校，再决定值不值得提前押注。",
    bullets: [
      "入围通常按高考分排序，校测时间常和综评、普通批节奏撞车。",
      "更适合把它当成单校判断：先看适合什么样的孩子，再看具体学校规则。",
    ],
        ...
        <div className={styles.heroLayout}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroLead}>
              上海考 985 主要有普通批、综合评价、强基三条路。先判断哪条是主线，再用 2021-2026
